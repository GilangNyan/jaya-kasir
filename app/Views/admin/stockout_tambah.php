            ...
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title">
                        ...
                        Catat Data Barang Keluar
                    </h3>
                </div>
                <div class="card-body">
                    <form action="<?= base_url('admin/stock/out/tambah') ?>" method="post" name="stockout" id="stockout" class="form-horizontal">
                        <?php csrf_field() ?>
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="detail" id="detail" class="form-control" placeholder="Rusak/Hilang/dll">
                            </div>
                        </div>
                        <div class="form-group row">
                ...
                <div class="card-footer">
                    <button class="btn btn-primary" type="submit" name="submit" id="submit" form="stockout">Catat</button>
                    <input class="btn btn-secondary" type="reset" name="reset" id="reset" value="Reset" form="stockout">
                    <a href="<?= base_url('admin/stock/out') ?>" class="btn btn-danger">Batal</a>
                </div>
            </div>
        </div>
    </div>
