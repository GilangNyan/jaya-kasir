    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    <form action="<?= base_url('admin/member/tambah') ?>" method="post" name="tambahmember" id="tambahmember" class="form-horizontal">
                        <?php csrf_field() ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea name="alamat" id="alamat" class="form-control <?= $validation->hasError('alamat') ? 'is-invalid' : '' ?>" rows="3"><?= old('alamat') ?></textarea>
                ...
                <div class="card-footer">
                    <button class="btn btn-primary" type="submit" name="submit" id="submit" form="tambahmember">Tambah</button>
